...
github.com/Synthesix/Sia/...`. This will download Sia and its dependencies
and install binaries in `$GOPATH/bin`.

After downloading, you can find the Sia source code in
`$GOPATH/src/github.com/Synthesix/Sia`. To build the release binary, run
...
```
consensus/fork.go:4:2: cannot find package "github.com/Synthesix/Sia/crypto" in any of:
    /usr/lib/go/src/github.com/Synthesix/Sia/crypto (from $GOROOT)
    /home/user/gopath/src/github.com/Synthesix/Sia/crypto (from $GOPATH)
```
